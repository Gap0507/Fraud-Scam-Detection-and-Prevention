...
import { PaperAirplaneIcon, ChatBubbleLeftRightIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline'
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (analysis.gemini_explanation) {
        // Use Gemini explanation for clean, human-friendly response
